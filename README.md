...
🛡️ **Durable review annotations:** annotate whole files (for non-json files) or structured targets such as JSON nodes, then revisit those annotations from the same local state.
